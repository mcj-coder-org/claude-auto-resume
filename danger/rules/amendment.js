...
import { hasEvidenceLink, extractEvidenceLinks } from '../lib/evidence.js';
 ...
 * @param {string} content - Plan file content
 */
export async function validateAmendments(planPath, content) {
  // Validate struck-through items have approval links
 ...
 */
export async function validateAllAmendments() {
