...
/**
 * Create auto-merge validator
 * @param {Object} dangerContext - The danger context
 */
export function createAutoMergeValidator(dangerContext) {
  const { danger, fail } = dangerContext;

  /**
   * Validate auto-merge is enabled
   */
  async function validateAutoMerge() {
   ...
   */
  async function validateIssueReference() {
   ...
   */
  return async function validateAutoMergeSettings() {
